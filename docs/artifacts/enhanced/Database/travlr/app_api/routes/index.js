...
// - Admin-only analytics for Category Three: Databases
...
router.get('/trips/analytics', authenticateJWT, requireAdmin, tripsController.tripsAnalytics);
...
// Analytics endpoint (admin only) for database aggregation results
router.get('/trips/analytics', authenticateJWT, requireAdmin, tripsController.tripsAnalytics);
